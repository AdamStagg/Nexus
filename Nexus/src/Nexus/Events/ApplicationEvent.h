...
namespace Nexus
{
	...
	class NEXUS_API WindowCloseEvent : public Event
	{
	public:
		WindowCloseEvent() {}
	...
	class NEXUS_API AppTickEvent : public Event
	{
		AppTickEvent() {}
	...
	class NEXUS_API AppUpdateEvent : public Event
	{
		AppUpdateEvent() {}
	...
	class NEXUS_API AppRenderEvent : public Event
	{
		AppRenderEvent() {}
